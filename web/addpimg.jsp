  ...
  <a href="index.jsp">Home</a>
    ...
    <body>
        ...
        <form action="./Image" method="post" enctype="multipart/form-data">
            ...
            <label> pid : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
            <input type="text" name="p1" placeholder="category"> 
            <br>
            <label> choose file : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
            <input type="file" name="f1" placeholder="category"> 
            <br>
